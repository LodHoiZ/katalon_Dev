...
WebUI.setText(findTestObject('Object Repository/login/Page_Register/input_Your Name_name'), Your_name)

WebUI.setText(findTestObject('Object Repository/login/Page_Register/input_Email address_email'), Your_email)

WebUI.setText(findTestObject('Object Repository/login/Page_Register/input_Username_usersname'), Your_username)
...
WebUI.setText(findTestObject('Object Repository/login/Page_Login/input_Sign up for free_usersname'), Your_username)
